...
test gnr denpop covidmean gini
...
*the model now is the most reduced version satisfying Gauss-Marokov hypothesis but covid has a positive coefficient which does not make sense



*te most reduced version of the model


reg lifesat hdi pol3 corru socsup free lune  
